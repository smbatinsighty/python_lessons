...
```
	...
	3. Առաջին x-ից ջնջեք երկրորդ y-ի հատումը:
	
	4. default ինչ պառամետր է ընդնում open() ֆունկցիան եթե իրան ոչինչ չփոխանցենք;
	
	5. 
	   3.1 Ստեղծել 2 file python-ի կոդի միջոցով: 
	       Յուրաքանչյուր file-ի մեջ գրել file-ի անվան հետ կապված տեսքտ
	
	   3.2 Արդեն ստղծված ֆայլերում ավելացնել տեսքտ առանց հին տեսքտը ջնջելու:
		    
		   
	   3.3 Ունենանք input սենց հրավերքի տեսքով 'which file do you want to read?'
